...
const HeroSection = () => {
    return (
        <section className="flex bg-[#FEF7F2] overflow-hidden relative">
            <div className="w-[50%] p-10 gap-5 flex flex-col justify-center items-start">
                <h1 className="text-[74px] text-[#281812] font-extrabold">Find Your Dream House</h1>
                <p className="font-bold text-[18px] text-[#4F5527]">
            ...
            <div className="absolute flex gap-4 py-10 px-4 bg-[#DDC788] rounded-[15px] bottom-5 right-50">
